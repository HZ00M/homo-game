package com.homo.game.proxy.facade;
...
public interface ICommonHttpClientProxy {
     ...
     * @return
     */
    Homo<Msg> clientPbMsgCheckToken(ClientRouterMsg clientRouterMsg);
     ...
     * @return
     */
    Homo<Msg> clientPbMsgCheckSign(ClientRouterMsg clientRouterMsg);
